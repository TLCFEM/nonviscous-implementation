...
\State \faMicrochip~update $\bbf\leftarrow\bbf+\delta\bbf=\dfrac{1}{1+s\Delta{}t}\bbf_n+\dfrac{m\Delta{}t}{1+s\Delta{}t}\left(\bw+\delta\bw\right)$\Comment{\eqsref{eq:incre_f}}
