...
\eqsref{eq:single_eom} can be equivalently expressed in the $s$-domain via Laplace transform. For some kernels, analytical solutions can be found and converted back to the time domain.