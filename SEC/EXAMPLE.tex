...
\end{gather}
The corresponding analytical solution can be sought by using the same technique as shown in \secref{sec:analytical_sdof} but with a more cumbersome algebraic operations. The displacement history and the corresponding convergence performance are shown in \figref{fig:sdof_forced}. Similar to the free vibration case, the second-order accuracy is retained.
\begin{figure}[H]
\centering
